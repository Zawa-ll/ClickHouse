...
REGISTER_FUNCTION(GenerateSnowflakeID)
{
    ...
    FunctionDocumentation::Syntax syntax = "generateSnowflakeID([machine_id, expr])";
    FunctionDocumentation::Arguments arguments = {{"machine_id", "Optional machine ID"}, {"expr", "Arbitrary expression"}};
